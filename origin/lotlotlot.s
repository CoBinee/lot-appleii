...
;[DA80] Z80 DISASSEMBLER Rev 0.12 - DISASSEMBLY LIST OF [lotlotlot.bin]
...
START:					;C800: 
        ...
        INC	HL			;C803: 23	"#"	
        LD	D,(HL)			;C804: 56	"V"	
        LD	(0D37DH),DE		;C805: ED537DD3	" S}�"	
        PUSH	HL			;C809: E5	" "	
        LD	A,085H			;C80A: 3E85	"> "	
        LD	(0D001H),A		;C80C: 3201D0	"2 �"	
        LD	HL,0D2E0H		;C80F: 21E0D2	"! �"	
        LD	B,020H			;C812: 0620	"  "	
LBLC814:				;C814: 
        LD	(HL),020H		;C814: 3620	"6 "	
        INC	HL			;C816: 23	"#"	
...
LBLC834:				;C834: 
        ...
        LD	A,E			;C838: 7B	"{"	
        CP	0AAH			;C839: FEAA	" �"	
        JR	NC,LBLC841		;C83B: 3004	"0 "	
        CP	096H			;C83D: FE96	"  "	
        JR	NC,LBLC84A		;C83F: 3009	"0 "	
LBLC841:				;C841: 
        LD	C,020H			;C841: 0E20	"  "	
        LD	(HL),E			;C843: 73	"s"	
        ADD	HL,BC			;C844: 09	" "	
...
LBLC84A:				;C84A: 
        ...
        LD	E,090H			;C858: 1E90	"  "	
LBLC85A:				;C85A: 
        LD	(0D300H),DE		;C85A: ED5300D3	" S �"	
        LD	DE,(0D302H)		;C85E: ED5B02D3	" [ �"	
        LD	HL,0CF9BH		;C862: 219BCF	"! �"	
        LD	A,D			;C865: 7A	"z"	
LBLC866:				;C866: 
        CP	005H			;C866: FE05	"  "	
        JR	C,LBLC86E		;C868: 3804	"8 "	
        SUB	005H			;C86A: D605	"� "	
...
LBLC87A:				;C87A: 
        ADD	HL,BC			;C87A: 09	" "	
        SUB	005H			;C87B: D605	"� "	
        JR	NC,LBLC87A		;C87D: 30FB	"0 "	
        LD	A,E			;C87F: 7B	"{"	
        CP	0AAH			;C880: FEAA	" �"	
        JR	NC,LBLC888		;C882: 3004	"0 "	
        CP	096H			;C884: FE96	"  "	
        JR	NC,LBLC891		;C886: 3009	"0 "	
LBLC888:				;C888: 
        LD	(HL),E			;C888: 73	"s"	
        INC	HL			;C889: 23	"#"	
        LD	(HL),E			;C88A: 73	"s"	
...
LBLC897:				;C897: 
        ...
        AND	01FH			;C899: E61F	"  "	
        CP	014H			;C89B: FE14	"  "	
        JR	NC,LBLC897		;C89D: 30F8	"0 "	
        LD	D,A			;C89F: 57	"W"	
        LD	E,090H			;C8A0: 1E90	"  "	
LBLC8A2:				;C8A2: 
        LD	(0D302H),DE		;C8A2: ED5302D3	" S �"	
        LD	HL,(0D37DH)		;C8A6: 2A7DD3	"*}�"	
        ADD	HL,HL			;C8A9: 29	")"	
        LD	A,R			;C8AA: ED5F	" _"	
        LD	B,A			;C8AC: 47	"G"	
        CP	H			;C8AD: BC	"�"	
        JR	NC,LBLC8CB		;C8AE: 301B	"0 "	
...
LBLC8CF:				;C8CF: 
        ...
        LD	(IX+0),020H		;C8D6: DD360020	"�6  "	
LBLC8DA:				;C8DA: 
        CP	085H			;C8DA: FE85	"  "	
        JR	NZ,LBLC922		;C8DC: 2044	" D"	
        LD	A,(IX+32)		;C8DE: DD7E20	"�~ "	
        CP	020H			;C8E1: FE20	"  "	
        JR	NZ,LBLC8EF		;C8E3: 200A	"  "	
        LD	(IX+0),A		;C8E5: DD7700	"�w "	
        LD	A,085H			;C8E8: 3E85	"> "	
        LD	(IX+32),A		;C8EA: DD7720	"�w "	
        JR	LBLC922			;C8ED: 1833	" 3"	
LBLC8EF:				;C8EF: 
        LD	A,(IX+255)		;C8EF: DD7EFF	"�~ "	
        CP	020H			;C8F2: FE20	"  "	
        JR	NZ,LBLC903		;C8F4: 200D	"  "	
        CP	(IX+1)			;C8F6: DDBE01	"ݾ "	
...
LBLC90A:				;C90A: 
        LD	A,020H			;C90A: 3E20	"> "	
        LD	(IX+0),A		;C90C: DD7700	"�w "	
        LD	A,085H			;C90F: 3E85	"> "	
        LD	(IX+1),A		;C911: DD7701	"�w "	
        JR	LBLC922			;C914: 180C	"  "	
LBLC916:				;C916: 
        LD	A,020H			;C916: 3E20	"> "	
        LD	(IX+0),A		;C918: DD7700	"�w "	
        LD	A,085H			;C91B: 3E85	"> "	
        LD	(IX+255),A		;C91D: DD77FF	"�w "	
        DEC	IX			;C920: DD2B	"�+"	
LBLC922:				;C922: 
        DEC	IX			;C922: DD2B	"�+"	
        LD	A,IXh			;C924: DD7C	"�|"	
...
LBLC955:				;C955: 
        ...
        DEC	DE			;C95C: 1B	" "	
        DEC	DE			;C95D: 1B	" "	
        CALL	MDLCB0E			;C95E: CD0ECB	"� �"	
LBLC961:				;C961: 
        DJNZ	LBLC955			;C961: 10F2	"  "	
        LD	(0D37DH),DE		;C963: ED537DD3	" S}�"	
        LD	B,006H			;C967: 0606	"  "	
        LD	C,000H			;C969: 0E00	"  "	
LBLC96B:				;C96B: 
        DEC	HL			;C96B: 2B	"+"	
...
LBLC972:				;C972: 
        ...
        LD	A,C			;C974: 79	"y"	
        LD	(0D37CH),A		;C975: 327CD3	"2|�"	
        LD	HL,DATCAC0		;C978: 21C0CA	"!��"	
        ...
        LD	HL,0D370H		;C9AB: 2170D3	"!p�"	
        LD	DE,0D372H		;C9AE: 1172D3	" r�"	
        LD	BC,0062H		;C9B1: 016200	" b "	
        LDDR				;C9B4: EDB8	" �"	
...
LBLC9F6:				;C9F6: 
        LD	A,E			;C9F6: 7B	"{"	
        CP	0A0H			;C9F7: FEA0	" �"	
        JR	C,LBLC9FD		;C9F9: 3802	"8 "	
        LD	E,0A0H			;C9FB: 1EA0	" �"	
LBLC9FD:				;C9FD: 
        CP	018H			;C9FD: FE18	"  "	
        JR	NC,LBLCA03		;C9FF: 3002	"0 "	
        LD	E,018H			;CA01: 1E18	"  "	
LBLCA03:				;CA03: 
        LD	A,D			;CA03: 7A	"z"	
        CP	0B4H			;CA04: FEB4	" �"	
        JR	C,LBLCA0A		;CA06: 3802	"8 "	
        LD	D,0B4H			;CA08: 16B4	" �"	
LBLCA0A:				;CA0A: 
        CP	008H			;CA0A: FE08	"  "	
        JR	NC,LBLCA10		;CA0C: 3002	"0 "	
        LD	D,008H			;CA0E: 1608	"  "	
LBLCA10:				;CA10: 
        LD	(0D310H),DE		;CA10: ED5310D3	" S �"	
        LD	A,E			;CA14: 7B	"{"	
        OR	D			;CA15: B2	"�"	
        LD	B,E			;CA16: 43	"C"	
        LD	E,A			;CA17: 5F	"_"	
        ...
        CALL	004DH			;CA22: CD4D00	"�M "	
        INC	HL			;CA25: 23	"#"	
        LD	A,D			;CA26: 7A	"z"	
        CALL	004DH			;CA27: CD4D00	"�M "	
        INC	HL			;CA2A: 23	"#"	
        XOR	A			;CA2B: AF	"�"	
        CALL	004DH			;CA2C: CD4D00	"�M "	
        INC	HL			;CA2F: 23	"#"	
        LD	A,005H			;CA30: 3E05	"> "	
        CALL	004DH			;CA32: CD4D00	"�M "	
        LD	DE,(0D370H)		;CA35: ED5B70D3	" [p�"	
        LD	A,E			;CA39: 7B	"{"	
        INC	HL			;CA3A: 23	"#"	
        CALL	004DH			;CA3B: CD4D00	"�M "	
        LD	A,D			;CA3E: 7A	"z"	
        INC	HL			;CA3F: 23	"#"	
        CALL	004DH			;CA40: CD4D00	"�M "	
        LD	A,004H			;CA43: 3E04	"> "	
        INC	HL			;CA45: 23	"#"	
        CALL	004DH			;CA46: CD4D00	"�M "	
        INC	HL			;CA49: 23	"#"	
        LD	A,009H			;CA4A: 3E09	"> "	
        CALL	004DH			;CA4C: CD4D00	"�M "	
        XOR	A			;CA4F: AF	"�"	
        CALL	00D8H			;CA50: CDD800	"�� "	
        AND	A			;CA53: A7	"�"	
        JR	NZ,LBLCA5C		;CA54: 2006	"  "	
        XOR	A			;CA56: AF	"�"	
        LD	(0D37FH),A		;CA57: 327FD3	"2�"	
        JR	LBLCA9B			;CA5A: 183F	" ?"	
LBLCA5C:				;CA5C: 
        LD	A,(0D37FH)		;CA5C: 3A7FD3	":�"	
        AND	A			;CA5F: A7	"�"	
        JR	NZ,LBLCA9B		;CA60: 2039	" 9"	
        INC	A			;CA62: 3C	"<"	
        LD	(0D37FH),A		;CA63: 327FD3	"2�"	
        LD	DE,(0D370H)		;CA66: ED5B70D3	" [p�"	
        CALL	MDLCAA4			;CA6A: CDA4CA	"ͤ�"	
        PUSH	IX			;CA6D: DDE5	"� "	
        POP	IY			;CA6F: FDE1	"  "	
        LD	DE,(0D310H)		;CA71: ED5B10D3	" [ �"	
        DB	0CDH			;CA75: CD	"�"	
LBLCA76:				;CA76: 
        DB	0A4H,0CAH		;CA76: A4CA	"��"	
        CALL	MDLCB25			;CA78: CD25CB	"�%�"	
        DB	00EH			;CA7B: 0E	" "	
LBLCA7C:				;CA7C: 
        DB	004H			;CA7C: 04	" "	
LBLCA7D:				;CA7D: 
...
LBLCA82:				;CA82: 
        LD	D,(IY+0)		;CA82: FD5600	" V "	
        LD	(IY+0),A		;CA85: FD7700	" w "	
LBLCA88:				;CA88: 
        LD	(IX+0),D		;CA88: DD7200	"�r "	
        INC	IX			;CA8B: DD23	"�#"	
        INC	IY			;CA8D: FD23	" #"	
...
LBLCAAE:				;CAAE: 
        ADD	IX,BC			;CAAE: DD09	"� "	
        SUB	030H			;CAB0: D630	"�0"	
        JR	NC,LBLCAAE		;CAB2: 30FA	"0 "	
        LD	A,E			;CAB4: 7B	"{"	
        SUB	014H			;CAB5: D614	"� "	
        LD	C,0A0H			;CAB7: 0EA0	" �"	
LBLCAB9:				;CAB9: 
...
DATCAC0:				;CAC0: 
        ...
        LD	B,L			;CAC3: 45	"E"	
        LD	D,D			;CAC4: 52	"R"	
        JR	NZ,LBLCA76		;CAC5: 20AF	" �"	
        JR	NZ,LBLCAF6		;CAC7: 202D	" -"	
        JR	NZ,LBLCAFE		;CAC9: 2033	" 3"	
        JR	NZ,LBLCA7C		;CACB: 20AF	" �"	
        JR	NZ,LBLCAEF		;CACD: 2020	"  "	
        JR	NC,LBLCAF1		;CACF: 3020	"0 "	
        JR	NZ,LBLCA82		;CAD1: 20AF	" �"	
        JR	NZ,LBLCB00		;CAD3: 202B	" +"	
        JR	NZ,LBLCB08		;CAD5: 2031	" 1"	
        JR	NZ,LBLCA88		;CAD7: 20AF	" �"	
        JR	NZ,LBLCB06		;CAD9: 202B	" +"	
        JR	NZ,LBLCB0F		;CADB: 2032	" 2"	
        JR	NZ,LBLCAFF		;CADD: 2020	"  "	
        DB	020H			;CADF: 20	" "	
MDLCAE0:				;CAE0: 
        DB	0D9H			;CAE0: D9	"�"	
        XOR	A			;CAE1: AF	"�"	
